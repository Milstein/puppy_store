...
<head>
    ...
    <title>Coverage for venv\Lib\site-packages\rest_framework\utils\mediatypes.py: 74%</title>
...
<p id="t48" class="stm run hide_run">        <span class="nam">self</span><span class="op">.</span><span class="nam">orig</span> <span class="op">=</span> <span class="str">''</span> <span class="key">if</span> <span class="op">(</span><span class="nam">media_type_str</span> <span class="key">is</span> <span class="key">None</span><span class="op">)</span> <span class="key">else</span> <span class="nam">media_type_str</span><span class="strut">&nbsp;</span></p>
<p id="t49" class="stm run hide_run">        <span class="nam">self</span><span class="op">.</span><span class="nam">full_type</span><span class="op">,</span> <span class="nam">self</span><span class="op">.</span><span class="nam">params</span> <span class="op">=</span> <span class="nam">parse_header</span><span class="op">(</span><span class="nam">self</span><span class="op">.</span><span class="nam">orig</span><span class="op">.</span><span class="nam">encode</span><span class="op">(</span><span class="nam">HTTP_HEADER_ENCODING</span><span class="op">)</span><span class="op">)</span><span class="strut">&nbsp;</span></p>
<p id="t50" class="stm run hide_run">        <span class="nam">self</span><span class="op">.</span><span class="nam">main_type</span><span class="op">,</span> <span class="nam">sep</span><span class="op">,</span> <span class="nam">self</span><span class="op">.</span><span class="nam">sub_type</span> <span class="op">=</span> <span class="nam">self</span><span class="op">.</span><span class="nam">full_type</span><span class="op">.</span><span class="nam">partition</span><span class="op">(</span><span class="str">'/'</span><span class="op">)</span><span class="strut">&nbsp;</span></p>
...
<p id="t54" class="stm run hide_run">        <span class="key">for</span> <span class="nam">key</span> <span class="key">in</span> <span class="nam">self</span><span class="op">.</span><span class="nam">params</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t58" class="stm run hide_run">        <span class="key">if</span> <span class="nam">self</span><span class="op">.</span><span class="nam">sub_type</span> <span class="op">!=</span> <span class="str">'*'</span> <span class="key">and</span> <span class="nam">other</span><span class="op">.</span><span class="nam">sub_type</span> <span class="op">!=</span> <span class="str">'*'</span> <span class="key">and</span> <span class="nam">other</span><span class="op">.</span><span class="nam">sub_type</span> <span class="op">!=</span> <span class="nam">self</span><span class="op">.</span><span class="nam">sub_type</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t61" class="stm run hide_run">        <span class="key">if</span> <span class="nam">self</span><span class="op">.</span><span class="nam">main_type</span> <span class="op">!=</span> <span class="str">'*'</span> <span class="key">and</span> <span class="nam">other</span><span class="op">.</span><span class="nam">main_type</span> <span class="op">!=</span> <span class="str">'*'</span> <span class="key">and</span> <span class="nam">other</span><span class="op">.</span><span class="nam">main_type</span> <span class="op">!=</span> <span class="nam">self</span><span class="op">.</span><span class="nam">main_type</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
...
<p id="t71" class="stm run hide_run">        <span class="key">if</span> <span class="nam">self</span><span class="op">.</span><span class="nam">main_type</span> <span class="op">==</span> <span class="str">'*'</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t72" class="stm run hide_run">            <span class="key">return</span> <span class="num">0</span><span class="strut">&nbsp;</span></p>
<p id="t73" class="stm run hide_run">        <span class="key">elif</span> <span class="nam">self</span><span class="op">.</span><span class="nam">sub_type</span> <span class="op">==</span> <span class="str">'*'</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t74" class="stm mis">            <span class="key">return</span> <span class="num">1</span><span class="strut">&nbsp;</span></p>
<p id="t75" class="stm run hide_run">        <span class="key">elif</span> <span class="key">not</span> <span class="nam">self</span><span class="op">.</span><span class="nam">params</span> <span class="key">or</span> <span class="nam">list</span><span class="op">(</span><span class="nam">self</span><span class="op">.</span><span class="nam">params</span><span class="op">)</span> <span class="op">==</span> <span class="op">[</span><span class="str">'q'</span><span class="op">]</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t76" class="stm run hide_run">            <span class="key">return</span> <span class="num">2</span><span class="strut">&nbsp;</span></p>
